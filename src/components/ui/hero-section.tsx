      ...
      <div className="container relative z-20 grid grid-cols-1 lg:grid-cols-2 gap-8 px-6 py-20">
        ...
        <div className="flex flex-col justify-center space-y-8">
          <div className="inline-block animate-fade-in opacity-0">
            <span className="inline-block px-3 py-1 rounded-full bg-blue-100 text-blue-800 text-xs font-medium tracking-wider">
              PORTFOLIO
            </span>
          </div>
          ...
          <h1 className="text-4xl md:text-6xl font-display font-bold tracking-tight animate-fade-in opacity-0 delay-100 text-white">
            ...
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300">Building Digital Experiences</span>
          </h1>
          
          <p className="text-lg md:text-xl text-gray-200 animate-fade-in opacity-0 delay-200 text-balance">
            Bringing imagination to life through elegant code and thoughtful design. 
            Crafting digital solutions that are as beautiful as they are functional.
          </p>
        ...
        <div className="relative hidden lg:flex items-center justify-center">
          ...
          <div className="relative w-full h-full max-w-md animate-float overflow-hidden rounded-2xl border-2 border-white/10">
            <div className="absolute inset-0 bg-gradient-to-t from-blue-900/40 via-transparent to-transparent z-10"></div>
            
            <div className="group relative overflow-hidden w-full h-full rounded-xl transform transition-all duration-500 hover:scale-105">
              <img 
                src="/lovable-uploads/4fcd0b14-628f-4b1f-8db8-970d2128d72a.png" 
            ...
            <div className="absolute bottom-4 left-4 w-20 h-20 border-b-2 border-l-2 border-white/20 rounded-bl-xl"></div>
          </div>
        </div>
      </div>
